...
\paragraph*{First Step:} You need to create \textbf{a back of your existing installation first}, at least everything from \textbf{/var/spool/news/wendzelnntpd} as you will need all these files later. Afterwards, install Wendzelnntpd-2.x on a Linux system (Windows is not supported anymore). This requires some libraries and tools. Under {\it Ubuntu} they all come as packages:
