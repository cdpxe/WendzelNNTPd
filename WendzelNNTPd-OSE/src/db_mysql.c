 ...
 *
 * Copyright (c) 2012 Steffen Wendzel <steffen (at) ploetner-it (dot) de>
 * 
...
void
db_mysql_acl_role_unconnect_group(server_cb_inf *inf, char *role, char *newsgroup)
{
	char *sql_cmd;
	int len;
...
void
db_mysql_acl_role_unconnect_user(server_cb_inf *inf, char *role, char *user)
{
	char *sql_cmd;
	int len;
