...
docker-run:
	docker run --name wendzelnntpd --rm -it -p 118:118 -p 119:119 -p 563:563 -v ${PWD}:/wendzelnntpd -v wendzelnntpd_data:/var/spool/news/wendzelnntpd wendzelnntpd:latest
